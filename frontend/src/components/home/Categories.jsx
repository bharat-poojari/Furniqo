  ...
  return (
    <section className="py-8 sm:py-12 bg-neutral-50 dark:bg-neutral-900">
      <div className="w-full px-[1%] sm:px-[1.5%]">
        ...
        {/* Categories Grid - Responsive grid and spacing */}
        <motion.div
        ...
        >
          {categories.slice(0, 6).map((category, index) => (
            ...
            >
              ...
              >
                {/* Image Container - Responsive rounded corners */}
                <div className="relative aspect-square rounded-lg sm:rounded-xl overflow-hidden bg-white dark:bg-neutral-800 shadow-md hover:shadow-xl transition-all duration-400">
                  ...
                  {/* Trending Badge - Responsive sizing */}
                  ...
                  {/* Shop Now Button - Responsive bottom positioning */}
                ...
                {/* Category Info - Responsive text sizes */}
              ...
              {/* Hover Glow Effect - Touch device safe */}
        ...
        {/* View All Categories Button - Responsive sizing */}
        <motion.div
        ...
        {/* Stats Section - All 4 stats in a single row on all screen sizes */}
        <div className="mt-[2%] sm:mt-[1%] mb-[2%] sm:mb-[1%] pt-4 border-t border-neutral-200 dark:border-neutral-800">
          <div className="grid grid-cols-4 gap-2 sm:gap-4 md:gap-6">
            {[
              ...
              <div key={idx} className="text-center group">
                <div className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 bg-primary-500/10 rounded-full flex items-center justify-center mx-auto mb-0.5 sm:mb-1 md:mb-2 group-hover:bg-primary-500/20 transition-colors duration-300">
                  <stat.icon className="h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-5 md:w-5 text-primary-600 group-hover:scale-110 transition-transform duration-300" />
                </div>
                <p className="text-xs sm:text-sm md:text-base lg:text-xl font-bold text-neutral-900 dark:text-white">{stat.value}</p>
                <p className="text-[8px] sm:text-[9px] md:text-[10px] lg:text-xs text-neutral-500 dark:text-neutral-400 whitespace-nowrap">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
